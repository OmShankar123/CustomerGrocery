...
const BUNDLE_ID = 'com.customer'; // ios bundle id
const PACKAGE = 'com.customer'; // android package name
const NAME = 'Customer'; // app name
const EXPO_ACCOUNT_OWNER = 'Customer'; // expo account owner
const EAS_PROJECT_ID = 'c3e1075b-6fe7-4686-aa49-35b46a229044'; // eas project id
const SCHEME = 'Customer'; // app scheme
